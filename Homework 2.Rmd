...
The AR(0) model suggests that the House Democratic majority decreases by `r abs(ar0$coef["PartisanMidterms"])` after midterms with a Democratic presidency, compared to non-midterm elections. The effect is in the opposite direction when there is a Republican president. 
...
```{r}
plot(Congress, DemSenateMaj, type="l")
...
plot(new.data$Congress, new.data$DemSenateMaj, type="l")
